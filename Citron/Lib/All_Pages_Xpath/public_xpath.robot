...
${close_call_center_mode_WS}                xpath=//div[@class="k-list-scroller"]//li[contains(.,'close_call_center_mode_WS')]                      # close_call_center_mode_WS
${close_call_center_mode_WS1}               xpath=//div[@class="k-list-scroller"]//li[contains(.,'close_call_center_mode_WS1')]                     # close_call_center_mode_WS1
${auto_default_workspace_xpath}             xpath=//div[@class="k-list-scroller"]//li[contains(.,'auto_default_workspace')]                         # auto_default_workspace
