...
Site_Admin_In_Site_Administration
    ...
    ...             AND         the_workspace_field_should_be_the_selected_one_before_loging_out     auto_default_workspace  # the workspace field shoud be the selected one before loging out.
    ...             AND         Close