...
Small_range_206
    ...
    # EU2 log in
    ${driver_EU2}   Get From List   ${drivers_list}    1
    # U3 log in
    ${driver_U3}    Get From List   ${drivers_list}    2
    # EU5 log in
    ${driver_EU5}   Get From List   ${drivers_list}    3
    # U6 log in
    ${driver_U6}    Get From List   ${drivers_list}    4
    # User log in
    ${driver_U7}    Get From List   ${drivers_list}    5
