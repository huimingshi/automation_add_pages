...
Small_range_1144_1153
    ...
    send_message_by_different_data     ${driver1}      ${plain_english_text}
    ${string1}    catenate     SEPARATOR=    ${used_by_message_username01}     ,
    ${string1}    catenate     ${string1}    ${used_by_message_username03}
    click_which_message     ${driver2}     ${string1}
    send_message_by_different_data     ${driver2}      ${plain_english_text}
    ${string2}    catenate     SEPARATOR=    ${used_by_message_username01}     ,
    ${string2}    catenate     ${string2}    ${used_by_message_username02}
    click_which_message     ${driver3}     ${string2}
...
Small_range_1154_1160
    ...
    send_message_by_different_data     ${driver1}      ${plain_english_text}
    ${string1}    catenate     SEPARATOR=    ${message_test0_username}     ,
    ${string1}    catenate     ${string1}    ${message_test2_username}
    click_which_message     ${driver2}     ${string1}
    send_message_by_different_data     ${driver2}      ${plain_english_text}
    ${string2}    catenate     SEPARATOR=    ${message_test0_username}     ,
    ${string2}    catenate     ${string2}    ${message_test1_username}
    click_which_message     ${driver3}     ${string2}
    send_message_by_different_data     ${driver3}      ${plain_english_text}
    [Teardown]      run keywords    delete_message_chat    ${driver1}
    ...             AND             exit_driver
...
Small_range_1161
    ...
    ${string3}    catenate     ${string3}    ${message_test3_username}
    click_which_message    ${driver3}     ${string3}
    ...
    ${string4}    catenate     SEPARATOR=    ${message_test0_username}     ,
    ${string4}    catenate     ${string4}    ${message_test2_username}
    click_which_message    ${driver4}     ${string4}
    see_last_content_on_message_dialog    ${driver4}     ${random_str}
    [Teardown]      run keywords    delete_message_chat    ${driver1}
    ...             AND             click_which_message    ${driver1}     ${string1}
    ...             AND             delete_message_chat    ${driver1}
    ...             AND             exit_driver
